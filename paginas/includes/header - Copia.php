	...
	<nav id="w_nav-header"> 
			...
			<div class="header">	
				...
				<ul class="menu"> 
					...
					<li><a href="<?php echo BASE.'/frontend' ?>" alt="frontend" class="<?php if(in_array('frontend', $link))echo 'active' ?>">FRONT END </a></li> 
			...
			<div class="w_submenu">
			<div class="w_backend <?php if(in_array('frontend', $link)){echo ' block';}else{ echo 'fechar';} ?>" > 
				<ul >  
			...
			<div class="w_backend <?php if(in_array('backend', $link)){echo ' block';}else{ echo 'fechar';} ?>" > 
				<ul >  
					<li><a href="">PHP</a></li> 
					<li><a href="">submenu back end</a></li>
					<li><a href="">submenu back end</a></li> 
					<li><a href="">submenu back end</a></li>	 
				</ul> 
			</div>
			<div class="w_backend <?php if(in_array('mysql', $link)){echo ' block';}else{ echo ' fechar';}?>" > 
				<ul> 
					<li><a href="">submenu banco de dados</a></li> 
					<li><a href="">submenu banco de dados</a></li> 
					<li><a href="">submenu banco de dados</a></li> 
					<li><a href="">submenu banco de dados</a></li> 	 	 
				</ul> 
			</div>
			<div class="w_backend <?php if(in_array('portifolio', $link)){echo ' block';}else{ echo ' fechar';} ?>" >
				<ul> 
					<li><a href="<?php echo BASE.'/paginas/aplicativos/' ?>">Aplicativos</a></li>
					<li><a href="">submenu portifolio</a></li> 	 	 
					<li><a href="">submenu portifolio</a></li> 	  
				</ul> 
			</div>
			<div class="w_backend <?php if(in_array('sobre', $link)){echo ' block';}else{ echo ' fechar';} ?>" >
				<ul> 
					<li><a href="">submenu sobre</a></li> 	
					<li><a href="">submenu sobre</a></li> 	
					<li><a href="">submenu sobre</a></li> 	 	 
				</ul> 
			</div>
			<div class="w_backend <?php if(in_array('contato', $link)){echo ' block';}else{ echo ' fechar';} ?>" >
				<ul> 
					<li><a href="">submenu contato</a></li> 	 
					<li><a href="">submenu contato</a></li> 	 
					<li><a href="">submenu contato</a></li> 	  
				</ul> 
			</div>
